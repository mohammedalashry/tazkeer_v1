...
<head>
	...
	<title>تذكير | حديث | البخاري </title>
...
<div class="header">
    <div class="menu">
        ...
        <ul class="desktopmenu">
            ...
            <li><a href="tafseer.php">تفسير</a></li>
            <li><a href="hadeeth.php">حديث</a></li>
        ...
        <div class="mobilemenu">
            ...
            <ul>
                ...
                <li menuelement><a href="tafseer.php">تفسير</a></li>
                <li menuelement><a href="hadeeth.php">حديث</a></li>
...
<div class="Hadeeth-body">
    <h4>صحيح البخاري</h4>
    <hr>

    <div>
        <input style="width:auto;" class="searchbox" contenteditable="true" type="text" placeholder="ابحث عن حديث ...">
        <button id="searchbutton">ابحث</button>
    </div>
    <hr>

    <div id="hadeeth-number">
        <p style="margin-left:10px;">اختر رقم الحديث</p>
    </div>
    <hr>
    <div class="hadeeth-page"></div>
    <div class='page-moving'>
        <label style="cursor:pointer;" class="previous-page">></label>
        <label class="current-page">1</label>
        <label style="cursor:pointer;" class="next-page"><</label>
